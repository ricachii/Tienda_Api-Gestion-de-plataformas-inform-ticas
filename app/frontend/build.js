...
// root is repo root (one level above app/frontend when this file is inside app/frontend)
...
// Minimal build script (moved into app/frontend): bundle frontend JS with esbuild and copy static files to dist/
const { build } = require('esbuild');
const fs = require('fs');
const path = require('path');

const frontend = path.resolve(__dirname);
const out = path.join(frontend, 'dist');
